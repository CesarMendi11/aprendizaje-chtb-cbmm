...
class ScreenIndexBuilder:
    ...
    def add_screen(
        ...
        self._screens[route] = {
            ...
            "in_screen_title": screen_data.get("in_screen_title", ""),
            "in_screen_title_source": screen_data.get("in_screen_title_source", ""),
            "in_screen_title_confidence": screen_data.get("in_screen_title_confidence", 0.0),
