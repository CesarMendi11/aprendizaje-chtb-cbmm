...
export function SemanticKnowledgePage({
  erp,
  selectedId,
  detail,
  treeMessage,
  ...
  return (
    <section className="admin-page admin-page--knowledge">
      <PageHeader
        ...
        description="Genera inferencias grounded, revisa la evidencia y registra decisiones humanas antes de publicar significado funcional."
      />
      <KnowledgeWorkspace
        erp={erp}
