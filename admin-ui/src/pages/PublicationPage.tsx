...
export function PublicationPage({
  ...
  return (
    <section className="admin-page">
      <PageHeader
        eyebrow="Operación"
        title="Publicación gobernada"
        description="Promueve versiones, cierra la cobertura estructural de la ACTIVE y proyecta únicamente conocimiento autorizado desde PostgreSQL hacia Neo4j y Chroma."
      />
      <div className="publication-principle">
        <span>Fuente de verdad</span>
        <strong>PostgreSQL autoriza</strong>
        <i>→</i>
        <strong>Neo4j relaciona</strong>
        <i>→</i>
        <strong>Chroma encuentra</strong>
      </div>
